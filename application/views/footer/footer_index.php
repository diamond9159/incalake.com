  ...
  <div class="row">
    <div class="col-md-6 col-xs-12">
      <div class="row">
        ...
        <div class="col-sm-4 col-xs-12"> <?= $partes[1]; ?> </div>
        <div class="col-sm-4 col-xs-12"> <?= $partes[2]; ?> </div>
