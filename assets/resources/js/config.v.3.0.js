		...
		if ( typeof object === "object" ) {
			object.forEach((value,index)=>{
				...
				if (value.type === 0 ) { // Acomulando el precio de solamente tours y/o servicio
					...
					if ( parseFloat(value.porcentaje_adelanto) <= 0 ) { // Si porcentaje es menor igual a 0 aplicamos el 100%
						this._montoPagarAdelantado += ( parseFloat(value.price)*parseFloat(value.quantity) ) * 100 / 100;
