    ...
    function actualizarDatos(){
        if (Cookies.get('cart')) {
            ...
            if ( itemData.length != 0 ) {
                ...
                objItem.feesTaxRate = feesAndTaxRate; // Enviando valor de tasas e impuestos en porcentaje %
                objItem.cupon       = cupon; // Enviando valor de cupón (Código Cupón)
            }
        }

        objPaypal                   = new ConfigPaypal();
        objPaypal.data              = objItem.data;
        objPaypal.taxCart           = objItem.totalFeesTaxRate;
        objPaypal.totalDiscountAmountCart = objItem.cuponMontoDescuento;
        ...
        console.log("******************** PAYPAL *******************");
        console.log("CUPON -",objItem.cupon,"%");
        console.log("FEES AND TAX",objItem.feesTaxRate,"%");
        console.log("SUB TOTAL AMOUNT",objPaypal.currencyCode,objItem.totalPriceData);
        console.log("FEES AND TAX", objItem.totalFeesTaxRate );
        //console.log("CUPON DESCUENTO",objPaypal.cuponMontoDescuento);
        console.log("CUPON DESCUENTO",objPaypal.totalDiscountAmountCart);
        console.log("TOTAL AMOUNT", objItem.totalPrice );
        ...
        objCulqi.amount         = objItem.totalPrice;
        ...
        console.log("SUB TOTAL AMOUNT",objCulqi.currency,objItem.totalPriceData);
        console.log("FEES AND TAX",objItem.totalFeesTaxRate);
        console.log("CUPON DESCUENTO",objItem.cuponMontoDescuento);
        ...
        objPYM.purchaseAmount           = objCulqi.amount;
        ...
        console.log("CURRENCY",objPYM.purchaseCurrencyCode);
        console.log("TOTAL AMOUNT",objPYM.purchaseAmount);
        console.log("TOTAL AMOUNT STRING",objPYM.purchaseAmountString);
    ...
    function culqi() {
        ...
        if(Culqi.token) {
            ...
            var serverData = {
                ...
                subTotalAmount  : (objItem.totalPrice).toFixed(2),
